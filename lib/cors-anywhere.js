...
function getHandler(options, proxy) {
    ...
    Object.keys(corsEscape).forEach(function (option) {
        if (Object.prototype.hasOwnProperty.call(options, option)) {
            corsEscape[option] = options[option];
        }
    });

    // Convert corsEscape.requireHeader to an array of lowercase header names, or null.
    ...
    return function (req, res) {
        ...
        if (!hasRequiredHeaders(req.headers)) {
            ...
            res.end('Missing required request header. Must specify one of: ' + corsEscape.requireHeader);
            return;
        }
